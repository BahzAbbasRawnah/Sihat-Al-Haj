...
$userName = $user['full_name_ar'] ?? $user['full_name_en'] ?? 'المسؤول';
...
<head>
    ...
    <meta name="description" content="صحة الحاج - لوحة تحكم المسؤول">
    <title>صحة الحاج - لوحة تحكم المسؤول</title>
...
<body class="font-sans bg-bg-secondary text-text-primary min-h-screen flex flex-col">
        ...
        <div class="container mx-auto">
            <div class="flex items-center justify-between py-3 px-4">
                ...
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-bold">صحة الحاج | لوحة تحكم المسؤول</h1>
                </div>
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-48 bg-bg-primary rounded-lg shadow-lg py-2 z-50 hidden user-dropdown-menu">
                            <a href="/sihat-al-haj/profile" class="block px-4 py-2 text-text-primary hover:bg-bg-secondary transition-colors">
                                <i class="fas fa-user-circle ml-2"></i>
                                <span data-ar="الملف الشخصي" data-en="Profile">الملف الشخصي</span>
                            </a>
                            <a href="/sihat-al-haj/admin/settings" class="block px-4 py-2 text-text-primary hover:bg-bg-secondary transition-colors">
    ...
    <div class="flex flex-1">
            ...
            <div class="h-full flex flex-col">
                ...
                <div class="p-4 border-b border-gray-700">
                    <div class="flex items-center space-x-3 space-x-reverse">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-300" data-ar="مسؤول النظام" data-en="System Administrator">مسؤول النظام</p>
                        </div>
                    </div>
                </div>
                ...
                <nav class="flex-1 py-4 overflow-y-auto scrollbar-thin">
                    <ul class="space-y-1 px-2">
                        <!-- Dashboard -->
                        <li>
                            <a href="/sihat-al-haj/admin/dashboard" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                        ...
                        <li class="pt-4">
                            <p class="px-4 text-xs text-gray-400 font-semibold mb-2" data-ar="إدارة المستخدمين" data-en="Users Management">إدارة المستخدمين</p>
                            
                            <a href="/sihat-al-haj/admin/users" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                        ...
                        <li class="pt-4">
                            <p class="px-4 text-xs text-gray-400 font-semibold mb-2" data-ar="الإدارة الطبية" data-en="Medical Management">الإدارة الطبية</p>
                            
                            <a href="/sihat-al-haj/admin/medical-teams" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                                <i class="fas fa-users w-5 text-center"></i>
                                <span data-ar="الفرق الطبية" data-en="Medical Teams">الفرق الطبية</span>
                            </a>
                            
                            <a href="/sihat-al-haj/admin/medical-centers" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                                <i class="fas fa-hospital w-5 text-center"></i>
                                <span data-ar="المراكز الطبية" data-en="Medical Centers">المراكز الطبية</span>
                            </a>
                            
                            <a href="/sihat-al-haj/admin/medical-requests" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                        ...
                        <!-- Services Section -->
                        <li class="pt-4">
                            <p class="px-4 text-xs text-gray-400 font-semibold mb-2" data-ar="الخدمات" data-en="Services">الخدمات</p>
                            
                            <a href="/sihat-al-haj/admin/services" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-primary hover:bg-opacity-20 transition-colors">
                                <i class="fas fa-concierge-bell w-5 text-center"></i>
                                <span data-ar="إدارة الخدمات" data-en="Services Management">إدارة الخدمات</span>
                            </a>
                        </li>
                        
                        <!-- Logout Section -->
                        <li class="pt-4 border-t border-gray-700 mt-4">
                            <a href="/sihat-al-haj/logout" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-nav-text hover:bg-red-600 hover:bg-opacity-20 transition-colors">
        ...
        <!-- Main Content Area -->
        <main class="flex-1 p-6 overflow-auto bg-bg-secondary">
